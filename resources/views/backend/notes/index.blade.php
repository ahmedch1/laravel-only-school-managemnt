    ...
    <div class="roles-permissions">
        ...
        <div class="mt-8 bg-white rounded border-b-4 border-gray-300">
            <div
                ...
                <div class="w-2/12 px-4 py-3">Matiére</div>
                <div class="w-2/12 px-4 py-3">Nom de l'élève(e)</div>
            ...
            @endrole
                    ...
                    <div class="w-2/12 flex items-center justify-end px-3">
                        ...
                        <a href="{{ route('notes.destroy', $note->id) }}"
                           data-url="{!! URL::route('notes.destroy', $note->id) !!}"
                           class="deletenote ml-1 bg-gray-600 block p-1 border border-gray-600 rounded-sm">
                            <svg class="h-3 w-3 fill-current text-gray-100" aria-hidden="true" focusable="false"
            ...
            @role('Parent')
            @foreach ($notes as $note)
                @if (Auth::user()->parent && $student && $student->parent_id == Auth::user()->parent->id )
