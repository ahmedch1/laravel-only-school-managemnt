    ...
    <div class="roles">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="{{ route('message.teacher') }}" class="bg-gray-200 text-gray-700 text-sm uppercase py-2 px-4 flex items-center rounded">
        ...
        <div class="table w-full mt-8 bg-white rounded">
            ...
            @endif
            <form action="{{ route('teacher.contact.parent') }}" method="POST" class="w-full max-w-xl px-6 py-12">
                @csrf
                    ...
                    <div class="md:w-2/3 block text-gray-600 font-bold">
                        <div class="relative">
                            <select name="user_id" class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                                <option value="">--Choisir un Parent à Contacter--</option>
