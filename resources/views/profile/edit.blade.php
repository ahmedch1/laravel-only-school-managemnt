        ...
        <div class="sm:flex sm:items-center sm:justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                ...
                <a href="{{ route('profile.change.password') }}"
                   class="bg-gray-200 text-gray-700 text-sm uppercase ml-2 py-2 px-4 flex items-center rounded">
                    <svg class="w-3 h-3 fill-current" aria-hidden="true" focusable="false" data-prefix="fas"
                    ...
                    <span class="ml-2 text-xs font-semibold">Changer Mot de passe</span>
                </a>
            </div>
        </div>
        <div class="mt-8 bg-white rounded">
            <form action="{{ route('profile.update') }}" method="POST"
                  class="w-full max-w-2xl mx-auto px-6 py-12 flex flex-wrap justify-between"
